...
export class ProcessingManager {
  ...
  static boomerang(source: sourceType, options: any): Promise<*> {
    const actualSource: string = getActualSource(source);
    return TrimmerManager.boomerang(actualSource, options);
  }

  static reverse(source: sourceType, options: any): Promise<*> {
    const actualSource: string = getActualSource(source);
    return TrimmerManager.reverse(actualSource, options);
  }
